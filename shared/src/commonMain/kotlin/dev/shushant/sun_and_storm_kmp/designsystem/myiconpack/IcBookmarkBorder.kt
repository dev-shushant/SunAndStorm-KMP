...
internal val MyIconPack.IcBookmarkBorder: ImageVector
    get() {
        if (_icBookmarkBorder != null) {
            return _icBookmarkBorder!!
        }
        _icBookmarkBorder = Builder(name = "IcBookmarkBorder", defaultWidth = 24.0.dp, defaultHeight
            ...
            path(fill = SolidColor(Color(0xFF201A1B)), stroke = null, strokeLineWidth = 0.0f,
                ...
                close()
                moveTo(17.0f, 18.0f)
                lineTo(12.4f, 15.994f)
                curveTo(12.145f, 15.883f, 11.855f, 15.883f, 11.6f, 15.994f)
                lineTo(7.0f, 18.0f)
                verticalLineTo(5.0f)
...
private var _icBookmarkBorder: ImageVector? = null
